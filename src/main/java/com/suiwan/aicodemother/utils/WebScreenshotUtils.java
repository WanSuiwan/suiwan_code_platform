package com.suiwan.aicodemother.utils;
...
public class WebScreenshotUtils {
    ...
    private static WebDriver getWebDriver() {
        try {
            ...
            // 设置用户代理
            options.addArguments("--user-agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.7632.160 Safari/537.36");
            // 创建驱动
